...
# Generated on: Wed Dec 27 19:09:08 IST 2023 (Wed Dec 27 13:39:08 GMT 2023)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/uart_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/uart_top -revised fv_map
...
add_search_path /home/vlsi1/Downloads/scl_pdk/stdlib/fs120/liberty/lib_flow_ff/ -library -both
read_library -liberty -both   /home/vlsi1/Downloads/scl_pdk/stdlib/fs120/liberty/lib_flow_ff/tsl18fs120_scl_ff.lib
...
add_search_path /home/vlsi1/23EC4224/project/UART_protocol/rtl/ -design -golden
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k /home/vlsi1/23EC4224/project/UART_protocol/rtl/uart.v
elaborate_design -golden -root {uart_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/uart_top/fv_map.v.gz
elaborate_design -revised -root {uart_top}
...
#add_name_alias fv/uart_top/fv_map.singlebit.original_name.alias.json.gz -revised
